...
func (g Galleries) Update(w http.ResponseWriter, r *http.Request) {
	...
	updatePath := fmt.Sprintf("/galleries/%d/edit", gallery.ID)
	http.Redirect(w, r, updatePath, http.StatusFound)
}
	...
	for _, fileHeader := range fileHeaders {
		...
		if err != nil {
			...
			if errors.As(err, &fileErr) {
				msg := fmt.Sprintf("%v has an invalid content type or extension. Only png, jpg, and gif files can be uploaded.", fileHeader.Filename)
